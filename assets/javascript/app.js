  ...
  function addressSearch(address) {
    ...
    $.ajax(url = urlString, method = 'GET').then(function (response) {
      ...
      if (divisions === undefined) {
        ...
        $("#address-image").html(`<img class="img-responsive img-thumbnail" src="https://maps.googleapis.com/maps/api/staticmap?size=800x300&maptype=roadmap&markers=${address}" alt="${address}"/> `)
